# -*- encoding: utf-8 -*-
# stub: rubocop-rails 2.37.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<rubocop>.freeze, [">= 1.89.0", "< 2.0"])
    s.add_runtime_dependency(%q<rubocop-ast>.freeze, [">= 1.44.0", "< 2.0"])
  else
    s.add_dependency(%q<activesupport>.freeze, [">= 4.2.0"])
    s.add_dependency(%q<lint_roller>.freeze, ["~> 1.1"])
    s.add_dependency(%q<rack>.freeze, [">= 1.1"])
    s.add_dependency(%q<rubocop>.freeze, [">= 1.89.0", "< 2.0"])
    s.add_dependency(%q<rubocop-ast>.freeze, [">= 1.44.0", "< 2.0"])
  end
end
