...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_development_dependency(%q<minitest>.freeze, ["~> 6.0.6"])
    s.add_development_dependency(%q<rake>.freeze, ["~> 13.4.2"])
  else
    s.add_dependency(%q<minitest>.freeze, ["~> 6.0.6"])
    s.add_dependency(%q<rake>.freeze, ["~> 13.4.2"])
  end
end
