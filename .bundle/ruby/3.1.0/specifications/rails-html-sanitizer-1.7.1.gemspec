...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<loofah>.freeze, ["~> 2.25", ">= 2.25.2"])
    s.add_runtime_dependency(%q<nokogiri>.freeze, [">= 1.15.7", "!= 1.16.0", "!= 1.16.0.rc1", "!= 1.16.1", "!= 1.16.2", "!= 1.16.3", "!= 1.16.4", "!= 1.16.5", "!= 1.16.6", "!= 1.16.7"])
  else
    s.add_dependency(%q<loofah>.freeze, ["~> 2.25", ">= 2.25.2"])
    s.add_dependency(%q<nokogiri>.freeze, [">= 1.15.7", "!= 1.16.0", "!= 1.16.0.rc1", "!= 1.16.1", "!= 1.16.2", "!= 1.16.3", "!= 1.16.4", "!= 1.16.5", "!= 1.16.6", "!= 1.16.7"])
  end
end
