...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/globalid/issues", "changelog_uri" => "https://github.com/rails/globalid/releases/tag/v1.4.0", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rails/globalid/tree/v1.4.0" } if s.respond_to? :metadata=
